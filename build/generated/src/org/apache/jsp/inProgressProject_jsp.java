...
public final class inProgressProject_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    ajax: {\n");
      out.write("                        url: '/HRManagement/inProgressServlet',\n");
      out.write("                        dataSrc: ''\n");
      out.write("                    },\n");
      out.write("                    columns: [\n");
      out.write("                        {data: null,\n");
      ...
      out.write("                                var momentDate = moment(data);\n");
      out.write("                                if (momentDate.isValid()) {\n");
      out.write("                                    return momentDate.format('DD-MM-YYYY');\n");
      out.write("                                } else {\n");
      ...
      out.write("</button>\n");
      out.write("        <button class=\"btn view-btn\" style=\"background-color: white;box-shadow: none\">\n");
      out.write(" <i class=\"fa-solid fa-eye text-primary\"></i>\n");
      out.write("</button>\n");
      out.write("                   `;\n");
      out.write("                            }\n");
      out.write("                        }\n");
      ...
      out.write("\n");
      out.write("                });\n");
      out.write("                $('#example tbody').on('click', '.view-btn', function () {\n");
      ...
      out.write("                    window.location.href = \"ProgressPage.jsp?id=\" + id;\n");
      out.write("\n");
      out.write("                });\n");
      ...
      out.write("            });\n");
      out.write("            $(document).ready(function () {\n");
      out.write("                // Counter to keep track of the number of task description input fields\n");
      out.write("                var numTasks = 1;\n");
      out.write("\n");
      out.write("                // Event listener for the \"More\" button that appends a new task description input field\n");
      out.write("                $('#more').click(function (e) {\n");
      out.write("                    e.preventDefault();\n");
      out.write("                    numTasks++;\n");
      out.write("                    var newTask = $('<div class=\"form-group\"><label for=\"Task\">Task Description:</label><input type=\"text\" class=\"form-control\" id=\"Task' + numTasks + '\" name=\"TaskDesc' + numTasks + '\"></div>');\n");
      out.write("                    $('#task-container').append(newTask);\n");
      out.write("                });\n");
      out.write("\n");
      out.write("                // Event listener for the form submission\n");
      out.write("                $(\".editform\").on(\"submit\", function (e) {\n");
      out.write("                    e.preventDefault();\n");
      out.write("\n");
      out.write("                    // Get the project ID and create a FormData object to hold the form data\n");
      out.write("                    var id = $('#example').DataTable().row({selected: true}).data().ProjectID;\n");
      out.write("                    var formData = new FormData();\n");
      out.write("\n");
      out.write("                    // Append the project ID to the form data\n");
      out.write("                    formData.append('ProjectID', id);\n");
      out.write("\n");
      out.write("                    // Loop through the task description input fields and append their values to the form data\n");
      out.write("                    for (var i = 1; i <= numTasks; i++) {\n");
      out.write("                        var taskValue = $('#Task' + i).val();\n");
      out.write("                        formData.append('descriptions[]', taskValue);\n");
      out.write("                    }\n");
      out.write("\n");
      out.write("                    // Send the form data to the server using an AJAX request\n");
      out.write("                    $.ajax({\n");
      out.write("                        method: \"POST\",\n");
      out.write("                        url: \"/HRManagement/AddTaskServlet\",\n");
      ...
      out.write("                    });\n");
      out.write("                });\n");
      out.write("                $('#editmodal').on('hidden.bs.modal', function () {\n");
      out.write("                    numTasks = 1;\n");
      out.write("                    $('#task-container').empty();\n");
      out.write("//                    $('#task-container').append(\n");
      out.write("//                            $('<div class=\"form-group\"><label for=\"Task\">Task Description:</label><input type=\"text\" class=\"form-control\" id=\"Task1\" name=\"TaskDesc1\"></div>')\n");
      out.write("//                            );\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("        </script>\n");
      ...
      out.write("                                    <li><a class=\"active\" href=\"inProgressProject.jsp\">In progress</a></li>\n");
      ...
      out.write("                                                <h3 class=\"modal-title\">Add Task</h3>\n");
      ...
      out.write("                                                    <label for=\"Task\">Task Description:</label>\n");
      out.write("                                                    <input type=\"text\" class=\"form-control\" id=\"Task1\" name=\"TaskDesc1\">\n");
      out.write("                                                </div>\n");
      out.write("                                                <div id=\"task-container\"></div>\n");
      out.write("                                            </div>\n");
      out.write("\n");
      out.write("                                            <div class=\"modal-footer\">\n");
      out.write("                                                <input type=\"submit\" value=\"Save\" class=\"btn btn-warning\" />\n");
      out.write("                                                <input type=\"reset\" value=\"More\" id=\"more\" class=\"btn btn-danger\"/>\n");
      out.write("                                            </div>\n");
      out.write("                                        </div>\n");
      out.write("                                    </div>\n");
      out.write("                                </div>\n");
