...
public final class noStartProject_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    var id = data.ProjectID;\n");
      out.write("                    var startDateStr = data.startDate;\n");
      out.write("                    var endDateStr = data.endDate;\n");
      out.write("                    var startDate = new Date(startDateStr);\n");
      out.write("                    var endDate = new Date(endDateStr);\n");
      out.write("                    var isoStartDate = startDate.toISOString().slice(0, 10);\n");
      out.write("                    var isoEndDate = endDate.toISOString().slice(0, 10);\n");
      ...
      out.write("                    $.get(\"getTeamValid\", {startDate: isoStartDate, endDate: isoEndDate}, function (responseJson) {                 // Execute Ajax GET request on URL of \"someservlet\" and execute the following function with Ajax response JSON...\n");
