...
<!--                                                                    <li><a class="edit_employee" data-toggle="modal" data-target="#edit"><i data-feather="edit"></i></a></li>-->
                                                        ...
                                                        <a class="btn-addmember" data-toggle="modal" data-target="#addteam">Add Report</a>
                                                    </div>
                                                </div>
                                                </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabela">Choose Your Team</h5>
                        ...
                        <div class="modal-body">
                            <div class=" col-md-12 p-0">
                                <div class=" form-popup m-0">
                                    <input type="text" placeholder="Reasson">
                                </div>
                            </div>
<!--                            <div class="modal-body">
                                <div class="col-md-12 p-0">
